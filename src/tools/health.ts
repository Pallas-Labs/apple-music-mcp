...
`;
    ...
    if (errorNumber === -600 || errorNumber === -10810 || errorNumber === -1728 || errorNumber === -43) return false;
    return true;
}
...
export const healthTool: ToolDef = {
    ...
    async handler() {
        ...
        return { structuredContent: response, logData: { musicRunning: health.musicRunning, permissionGranted: health.permissionGranted } };
    },
};
